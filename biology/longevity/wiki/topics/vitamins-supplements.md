---
id: topic-vitamins-supplements
topic: vitamins-supplements
---

# Vitamins and supplements

Most well-powered RCTs of vitamin / mineral / botanical
supplementation in non-deficient adults are null on hard endpoints.
The evidence base is largely "fix deficiency if present, otherwise
don't bother."

## Disconfirming evidence (well-powered RCTs)
- [[papers/vital-2019-vitd-omega3]] — VITAL trial, n=25,871,
  5.3-yr follow-up. Vitamin D 2000 IU/day did not reduce cancer,
  CVD, or all-cause mortality in non-deficient adults.
- [[papers/nr-longcovid-2025]] — nicotinamide riboside in
  long-COVID; blood NAD+ rises but clinical endpoints don't move.

## What this means in practice
- Test before treating (25-OH vitamin D, B12, ferritin, TSH).
- Supplement only documented deficiencies.
- Be skeptical of "longevity stack" supplement marketing; the RCT
  evidence base is thin to negative.

## Possibly useful (small evidence base)
- [[papers/urolithin-a-immune-2025]] — Mitopure: a clean Nature
