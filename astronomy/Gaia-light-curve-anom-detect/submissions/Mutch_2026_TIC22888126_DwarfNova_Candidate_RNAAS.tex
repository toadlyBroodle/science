...
The International Variable Star Index \citep[VSX;][]{Watson2006} contains millions of variable stars lacking physical classification. We applied Isolation Forest anomaly detection \citep{Liu2008} to Gaia DR3 \texttt{vari\_summary} statistics to identify unusual objects. TIC~22888126, catalogued as generic ``VAR'' with $P=57.3$~min, showed extreme skewness ($-3.94$) and kurtosis ($+18.5$), prompting archival investigation.
